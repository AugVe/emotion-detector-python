...
This suite covers endpoint availability, input validation, and error handling 
using a mocked environment for external dependencies.
"""
...
def test_emotion_detector_success():
    ...
    with patch("server.emotion_detector") as mock_api:
        ...
        response = client.get("/emotionDetector?textToAnalyze=I%20love%20coding")
...
def test_emotion_detector_empty_input():
    ...
    Validates that the Global Exception Handler correctly formats InvalidInputError.
    """
